<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="java.util.*, java.sql.*, model.UserDAO"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<div style="min-width: 1500px; width: 100%;">
		...
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://onedays.cq2qma9rqvji.us-east-2.rds.amazonaws.com/onedays", "admin",
			"sungshin");
		...
		<p class="rs"
			style="width: 100%; text-align: center; padding-top: 150px;">
			<font color='red'><%=cat[cat_n - 1]%> 클래스</font>를 제일 좋아하시는 군요!
		</p>
		...
		<div style="width: 100%; text-align: center;">
			...
			<%
				String jspcat[] = { "craftsCat.jsp", "cookCat.jsp", "instCat.jsp", "itCat.jsp", "activityCat.jsp", "artCat.jsp",
					"designCat.jsp", "beautyCat.jsp", "petCat.jsp", "flowerCat.jsp" };
			%>
