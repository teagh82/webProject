...
<head>
    ...
    <script>
        ...
        <%String r = "-1"; %>
        function selectChange(obj, v)
    	{
    		obj.submit(); //obj자체가 form이다.
    		<%=r%> = v;
    		 $("cate").load(window.location.href + "cate");
    	}
...
<body>
    ...
    <h2>액티비티 클래스</h2>
    <h3 class="cr"> 지역 </h3>
    <form action="activityCatR.jsp">

    <div class="cat_region"> <!-- onchange="selectChange(this.form, this.value);" -->
	...
	<%
	ArrayList<ClassVO> list = dao.getCategorylist(5,r);
    %>
